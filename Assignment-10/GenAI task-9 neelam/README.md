...
Run the following command in the project directory to install all required dependencies: uv sync

Running the Application
To run the application, use:
uv run python main.py

I use Jupyter Notebook for graph questions because graphs are not displaying properly in my main.py file